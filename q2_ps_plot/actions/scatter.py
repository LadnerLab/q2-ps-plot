...
def repScatters(
    ...
    # start the default dict for collecting scatterplot values and add the
    # following keys
...
# Method inputs/parameters: output_dir, source, metadata, zscore,
# reference_file, peptide_header, reference_header, x_axis_header,
# category_header, label_header, x_axis_label, y_axis_label, min_wobble,
# max_wobble, wobble, scatter_only, scatter_boxplot, boxplot_only
...
def mutantScatters(
    ...
    zscore = zscore.rename(columns={
        "Sequence name": peptide_header,
        "level_1": "Samples",
        0 : "value"
    })
    ...
    if reference_file:
        ...
        labelDict = {
            reference_header: CodeName, x_axis_header: Position,
            "labeling": labeling
        }
