...
repScatters_parameter_descriptions = {
        ...
        "facet_charts": "Allows for view of all tables on one page instead of"
            " the available dropdown menu.",
        "pn_filepath": "Filepath of .tsv pairs file generated by standalone"
            " autopepsirf python script, containing all sample pairings,"
            " typically ending in '_PN.tsv'. (Depricated)",
